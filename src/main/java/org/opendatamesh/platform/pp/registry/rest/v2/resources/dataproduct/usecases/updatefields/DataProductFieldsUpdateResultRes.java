...
public class DataProductFieldsUpdateResultRes {

    @Schema(description = "The updated data product")
    private DataProductRes dataProduct;

    public DataProductFieldsUpdateResultRes() {
    }

    public DataProductFieldsUpdateResultRes(DataProductRes dataProduct) {
