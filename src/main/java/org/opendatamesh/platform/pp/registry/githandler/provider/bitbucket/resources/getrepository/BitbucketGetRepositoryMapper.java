...
public abstract class BitbucketGetRepositoryMapper {
     ...
     */
    public static Repository toInternalModel(BitbucketGetRepositoryRepositoryRes repoRes, OwnerType ownerType) {
        if (repoRes == null) {
            return null;
        }
     ...
     */
    private static List<AdditionalProviderProperty> buildAdditionalProperties(BitbucketGetRepositoryRepositoryRes repoRes) {
