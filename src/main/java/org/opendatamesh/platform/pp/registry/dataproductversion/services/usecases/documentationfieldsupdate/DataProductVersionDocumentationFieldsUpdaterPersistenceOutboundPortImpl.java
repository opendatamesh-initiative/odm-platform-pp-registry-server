...
class DataProductVersionDocumentationFieldsUpdaterPersistenceOutboundPortImpl implements DataProductVersionDocumentationFieldsUpdaterPersistenceOutboundPort{
    private final DataProductVersionCrudService dataProductVersionCrudService;

    DataProductVersionDocumentationFieldsUpdaterPersistenceOutboundPortImpl(DataProductVersionCrudService dataProductVersionCrudService) {
