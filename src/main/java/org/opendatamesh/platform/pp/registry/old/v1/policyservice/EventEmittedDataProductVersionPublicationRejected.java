...
class EventEmittedDataProductVersionPublicationRejected {
    private Long sequenceId;
    private final String resourceType = "DATA_PRODUCT_VERSION";
    private String resourceIdentifier;
    private final String type = EventTypeRes.DATA_PRODUCT_VERSION_PUBLICATION_REJECTED.name();
    private final String eventTypeVersion = "v2.0.0";
    private EventContent eventContent;

    public EventEmittedDataProductVersionPublicationRejected() {
    }
