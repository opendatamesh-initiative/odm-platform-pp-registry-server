package org.opendatamesh.platform.pp.registry.utils.git.provider.azure;
...
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.createrepository.AzureCreateRepositoryMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.createrepository.AzureCreateRepositoryRepositoryRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.createrepository.AzureCreateRepositoryReq;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.getcurrentuser.AzureGetCurrentUserMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.getcurrentuser.AzureGetCurrentUserUserResponseRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.getrepository.AzureGetRepositoryMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.getrepository.AzureGetRepositoryProjectListRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.getrepository.AzureGetRepositoryRepositoryRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listbranches.AzureListBranchesBranchListRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listbranches.AzureListBranchesMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listcommits.AzureListCommitsCommitListRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listcommits.AzureListCommitsCommitRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listcommits.AzureListCommitsMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listrepositories.AzureListRepositoriesMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listrepositories.AzureListRepositoriesProjectListRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listrepositories.AzureListRepositoriesRepositoryListRes;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listtags.AzureListTagsMapper;
import org.opendatamesh.platform.pp.registry.utils.git.provider.azure.resources.listtags.AzureListTagsTagListRes;
