...
public class PolicyResPolicy {
    ...
    private List<PolicyResPolicyEvaluationEvent> evaluationEvents;
    private String filteringExpression;
    private Boolean isLastVersion;
    private PolicyResPolicyEngine policyEngine;
    private ObjectNode externalContext;

    public PolicyResPolicy() {
    }
    ...
    public PolicyResPolicyEngine getPolicyEngine() {
        return policyEngine;
    }

    public void setPolicyEngine(PolicyResPolicyEngine policyEngine) {
        this.policyEngine = policyEngine;
    }

    public List<PolicyResPolicyEvaluationEvent> getEvaluationEvents() {
        return evaluationEvents;
    }

    public void setEvaluationEvents(List<PolicyResPolicyEvaluationEvent> evaluationEvents) {
