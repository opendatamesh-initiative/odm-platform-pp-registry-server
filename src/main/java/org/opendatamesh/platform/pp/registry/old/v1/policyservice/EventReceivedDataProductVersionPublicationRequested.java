...
class EventReceivedDataProductVersionPublicationRequested {
    private final String resourceType = "DATA_PRODUCT";
    private String resourceIdentifier;
    private final String type = EventTypeRes.DATA_PRODUCT_VERSION_PUBLICATION_REQUESTED.name();
    private final String eventTypeVersion = "v2.0.0";
    private EventContent eventContent;

    public EventReceivedDataProductVersionPublicationRequested() {
    }
