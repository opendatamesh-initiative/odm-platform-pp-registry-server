...
class EventEmittedDataProductInitializationRejected {
    private final String resourceType = "DATA_PRODUCT";
    private String resourceIdentifier;
    private final String type = EventTypeRes.DATA_PRODUCT_INITIALIZATION_REJECTED.name();
    private final String eventTypeVersion = "v2.0.0";
    private EventContent eventContent;

    EventEmittedDataProductInitializationRejected() {
    }
